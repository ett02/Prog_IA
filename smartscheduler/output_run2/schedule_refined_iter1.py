...
def solve_schedule():
    ...
    # Worker W04
    preference_weights["W04"] = {'morning': 2, 'afternoon': 2, 'night': 3}  # aumentato peso per turni notturni
...
solve_schedule()
# MODIFICHE: Aumentato peso per turni notturni di W04 e penalità minori per turni preferiti